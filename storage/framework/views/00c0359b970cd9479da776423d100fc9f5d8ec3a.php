			...
			<div class="col-lg-12">
                  <div class="procedure_div">
                    	...
                    	<div class="calibration_from_div">
                            <form action="<?php echo e(route('calibration')); ?> " method="POST">
                                <?php echo csrf_field(); ?>
                    			<div class="row">
								...
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="kt_table_agent">
                                    ...
                                    <tbody>
										<?php
											$i=1;
										?>
                                        <?php $__currentLoopData = $caliber; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($i++); ?></td>
								...
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="kt_table_agent">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($data->equipment); ?></td>
                                            <td><?php echo e($data->serialNum); ?></td>
                                            <td><?php echo e($data->locaction); ?></td>
                                            <td><?php echo e($data->testMethod); ?></td>
                                            <td><?php echo e($data->acceptance); ?></td>
                                            <td><?php echo e(date('d-M-Y', strtotime($data->calibratedDate))); ?> </td>
                                            <!--<td><?php echo e($data->calibratedDate); ?></td>-->
                                            <td><?php echo e($data->certificatenumber); ?></td>

                                            <td><?php echo e($data->freq); ?></td>
                                            <td><?php echo e($data->reportRev); ?></td>
                                            <td><?php echo e($data->sentence); ?></td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
								</table>
...
<div class="modal fade" id="editcustomer_rev" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
                <form action="<?php echo e(route('calibrationedit')); ?> " method="POST">
                    <?php echo csrf_field(); ?>
            <?php 
            $urlparam = request()->route()->parameters;
            ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/calibration_record.blade.php ENDPATH**/ ?>