                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr>
                                ...
                                <td><?php echo e($blog->user->f_name); ?> <?php echo e($blog->user->l_name); ?></td>
                                <td>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="<?php echo e(route('blog.show',$blog->id)); ?>" style="height: 33px; margin-left: 10px" class="btn btn-sm bg-warning edit-quiz"><i class="fa fa-eye"></i></a>

                                    <a href="<?php echo e(route('blog.edit',$blog->id)); ?>" style="height: 33px; margin-left: 10px" class="btn btn-sm bg-primary edit-quiz"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('layout.admin_panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\expertgateway\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>