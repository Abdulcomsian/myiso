                            ...
                            <input type="hidden" name="user_id" value="<?php echo e($urlparam['userid']); ?>">
                    			<div class="row">
                    				...
                    				<div class="col-lg-12">
										...
										<?php if(isset($all_customers) && $all_customers != ""): ?><?php else: ?> 
                    	...
                    	<div class="requirments_table_div">
                    		...
                    		<div class="kt-portlet__body table-responsive">
								...
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive">
									...
									<tbody>
                                        <?php $__currentLoopData = $customer_review; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<tr>
                                            ...
                                            <td>
                                                <button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="info" value="" onclick="getEid(<?php echo e($data); ?>);">
												...
												<button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="delete" value="" onclick="deletedata(<?php echo e($data); ?>);"><i class="la la-trash"></i>
                                                </button>
                                            </td>
...
<div class="modal fade" id="deleteRequirment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?php echo e(route('deleteCustomerRivewAdmin')); ?>" method="POST">
				<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/customer_review.blade.php ENDPATH**/ ?>