...
<p>Sometimes substances are easily recognised as harmful. Common substances such as paint, bleach or dust from natural materials may also be harmful.</p>
                    <div class="procedure_div">
                    	...
                    	<div class="process_interested_from_div" style="display:none">
                    		<form action="<?php echo e(route('chemicalform')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                    			<div class="row">
									<div class="col-lg-12">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" name="location" class="form-control" required  placeholder="Enter Location Used (Consider area or department where the chemical is being used">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" name="activity_hazard" class="form-control" required placeholder="Enter Activity Hazard (Consider chemical use, making additions, chemical discarding etc)">
										</div>
									</div>
								</div>
								<div class="row">
                    ...
                    <div class="procedure_div">
                    	<div class="requirments_table_div">
                    		<div class="kt-portlet__body table-responsive">
								<!--begin: Datatable -->
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive chemical_table" id="kt_table_agent">
									<thead>
										<tr>
											<th>S-No</th>
											<th>Chemical Name</th>
									...
									<tbody>
										...
										?>
                                        <?php $__currentLoopData = $chemical; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $counter++; ?>
										<tr>
											<td><?php echo e($i++); ?></td>
											<td><?php echo e($data->chemical_name); ?></td>
											<td><?php echo e($data->chemical_desc); ?></td>
											<td><?php echo e($data->location_used); ?></td>
											<td><?php echo e($data->activity_hazard); ?></td>
											<td><?php echo e($data->still_used); ?></td>
                                            ...
                                            <button data-toggle="modal" data-target="#deleteChemechal_id<?php echo e($data->id); ?>" style="top: -2px;position: relative;border: none !important;background: transparent !important;">
                                        ...
                                        <div class="modal fade" id="deleteChemechal_id<?php echo e($data->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
                                        	<div class="modal-dialog" role="document">
                                        		<div class="modal-content">
                                        			...
                                        			<div class="modal-footer">
                                                      <form action="<?php echo e(url('/chemical_control_delete')); ?>" method="POST">
                                                         <?php echo csrf_field(); ?>                                                         
...
<div class="modal fade" id="editinterestedmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-lg">
            ...
            <form action="<?php echo e(route('chemicalUpdate')); ?>" method="POST">
                <?php echo csrf_field(); ?>
			<div class="modal-body">
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/dashboard/form_records/chemical_control.blade.php ENDPATH**/ ?>