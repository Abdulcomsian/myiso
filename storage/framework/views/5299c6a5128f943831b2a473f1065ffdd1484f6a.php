												...
												<div class="kt-widget17__stats">
													<div class="kt-widget17__items">
															...
															<span class="kt-widget17__icon">
																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--brand">
																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																		...
																		<rect id="Rectangle-Copy-2" fill="#fff" opacity="0.3" transform="translate(17.825568, 11.945519) rotate(-19.000000) translate(-17.825568, -11.945519) " x="16.3255682" y="2.94551858" width="3" height="18" rx="1" />
																	</g>
																</svg> </span>
															<span class="kt-widget17__subtitle text-warning">
															<a href="<?php echo e(url('quality_manual')); ?>">
														...
														<div class="kt-widget17__item newColor">
															...
															<span class="kt-widget17__subtitle text-success">
																<a href="<?php echo e(url('sale_processes')); ?>">
																	Processes</a>
													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item newColor">
															...
															<span class="kt-widget17__subtitle text-warning">
																<a href="<?php echo e(url('documented_information')); ?>">
																	Procedures</a>
														...
														<div class="kt-widget17__item newColor">
															<span class="kt-widget17__icon">
													<span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-09-29-132851/theme/html/demo1/dist/../src/media/svg/icons/Files/File.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#fff" x="6" y="15" width="5" height="2" rx="1"/>
															...
															<span class="kt-widget17__subtitle">
																<a href="<?php echo e(url('requirements_aspect')); ?>"> Forms and Records</a>
													...
													<div class="kt-widget17__items">
														<div class="kt-widget17__item newColor">
															...
															<span class="kt-widget17__subtitle">
																...
																<a href="<?php echo e(url('work_instruction')); ?>">
								...
								<div class="col-xl-8">
									...
									<div class="kt-portlet kt-portlet--height-fluid">
									 ...
									 $d = strtotime($data->completion_date);
																	...
																	<td><a href="#" data-id="<?php echo e($data->id); ?>" class="delete_requirement" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">	
											...
											<div class="row ml-0 mr-0 table-responsive">
												...
												<?php if($user['iso9001_certificate']): ?>
													<tr>
														<th>ISO9001</th>
														<td>
															<a href="public/<?php echo e($user['iso9001_certificate']); ?>" target="_blank">
												...
												<?php if($user['iso14001_certificate']): ?>												
													<tr>
														<th>ISO14001</th>
														<td>
															<a href="public/<?php echo e($user['iso14001_certificate']); ?>" target="_blank">
																<i class="far fa-file-pdf fa-2x" style="color:red;"></i>
															</a>
														</td>
												...
												<?php if($user['iso45001_certificate']): ?>
													<tr>
														<th>ISO45001</th>
														<td>
															<a href="public/<?php echo e($user['iso45001_certificate']); ?>" target="_blank">
																<i class="far fa-file-pdf fa-2x" style="color:red;"></i>
															</a>
														</td>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hashir/Documents/myiso/resources/views/dashboard/index.blade.php ENDPATH**/ ?>