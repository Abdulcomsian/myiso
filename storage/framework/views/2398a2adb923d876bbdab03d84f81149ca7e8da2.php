		...
		<div class="row">
			<div class="col-lg-12">
					...
					<p>Audits will be conducted in accordance with
						<a href="<?php echo e(url('audit')); ?>">Audits</a></p>
          ...
          <!--          			</div> -->
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="form-group">
											<label>Evidence:</label>
											<input type="text" name="evidence28_1" class="form-control"  placeholder="Enter Evidence:">
										</div>
									</div>
								</div>
									<div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="date" max="2999-12-31"  placeholder="dd-mm-yyyy" data-date="" data-date-format="DD MM YYYY" name="competedDate" class="form-control" placeholder="Enter Evidence:" required="required">
										</div>
									</div>
								</div>
								<div class="row">
                    ...
                    <div class="procedure_div">
                    	<div class="requirments_table_div">
							<a href="/edit_user/<?php echo e($urlparam['userid']); ?>" class="btn btn-clean btn-icon-sm mb-2 back_icon" style="float: right;">
                    		...
                    		<div class="kt-portlet__body table-responsive">
								...
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="kt_table_agent">
                                    ...
                                    <tbody>
										...
										$i=1;
									?>
                                        <?php $__currentLoopData = $auditreport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php echo e($i++); ?>
                      ...
                      <div class="modal-content">
                        <form action="<?php echo e(route('deleteqmsAudit')); ?>" method="post">
                          <div class="modal-header justify-content-center"> <?php echo csrf_field(); ?> 
                            <div class="modal-profile"><h5>Deleting QMS Audit Details</h5></div>
                          </div>
                   ...
                   <div class="row">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<label>Audit Comments and Actions:</label>
											<input type="text" class="form-control" name="audit_comments_actions" required   placeholder="Enter Comment:">
										</div>
									</div>
									<div class="col-lg-12">
										<div class="form-group">
											<label>Date Completed (MM/DD/YYYY):</label>
											<input type="date" max="2999-12-31" name="competedDate"  required class="form-control"  placeholder="Enter Evidence:">
										</div>
									</div>
								</div>
								<div class="row">
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/qms_audit.blade.php ENDPATH**/ ?>