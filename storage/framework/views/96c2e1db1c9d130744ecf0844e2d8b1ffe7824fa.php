                                ...
                                <!--begin::Form-->
                                    ...
                                    <div class="d-flex flex-column align-items-start flex-xxl-row">
                                        ...
                                        <div class="d-flex flex-center flex-equal fw-row text-nowrap order-1 order-xxl-2 me-4" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Enter invoice number">
                                            <span class="fs-2x fw-bolder text-gray-800">Fixed Price Service</span>
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    <!--end::Top-->
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <div class="row gx-10 mb-5">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <?php echo e($fixed_service->title); ?>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <?php echo e($fixed_service->price); ?>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <?php echo e($fixed_service->expertise->name); ?>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <!--begin::Input group-->
                                                <div class="mb-5">
                                                    <img src="<?php echo e(asset('fixed_service/'.$fixed_service->image)); ?>" width="180px" height="180px">
                                                </div>
                                                <!--end::Input group-->
                                            </div>
                                            <!--end::Col-->
...
<?php echo $__env->make('layout.admin_panel.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\expertgateway\resources\views/admin/fixed_service/show.blade.php ENDPATH**/ ?>