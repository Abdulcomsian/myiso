            ...
            <div class="col-lg-12">
                ...
                <div class="procedure_div">
                    ...
                    <div class="non_conformities_from_div">
                        <form action="<?php echo e(route('nonConfromForm')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
            <?php 
                        ...
                        <div class="kt-portlet__body table-responsive">
                            ...
                            <table class="common_table non_conformities_table table table-striped- table-bordered table-hover table-checkable table-responsive"
                                ...
                                <tbody>
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $customers_nonconform; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo e($data->root_cause_category); ?></td>
                                            <td> <?php echo e($data->dateNcR); ?></td>
                                            <td> <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="view"
                                                    value="<?php echo e($data->customerID); ?>"
                                                    onclick="getEid(<?php echo e(json_encode($data)); ?>);"> <i
                                                        class="la la-info"></i>
                                                </button>
                                                
                                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete"
                                                    onclick="removeinfo(<?php echo e($data->noid); ?>);"><i
                                                        class="la la-trash"></i>
                                                </button>
                                                
                                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit"
                                                    onclick="EditData(<?php echo e(json_encode($data)); ?>);"><i
                                                        class="la la-edit"></i>
                                                </button>
                                            </td>
...
<div class="modal fade" id="editConfirm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="form-row">
                <div class="col-md-12 p-3">
                    <form action="<?php echo e(route('editnonConfirm')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="deleteRequirment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo e(route('deleteNonConfrm')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<script>
    function get_customer(obj) {
        ...
        jQuery.ajax({
            url: "<?php echo e(url('/get_customer_name_by_id')); ?>",
            type: "POST",
            data: {
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/non_conformities.blade.php ENDPATH**/ ?>