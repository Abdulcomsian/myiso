                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $customers_nonconform; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(date('d-M-Y', strtotime($data->dateNcR))); ?></td>
                                    <td> <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View"
                                            ...
                                            <!--<i class="la la-info"></i>-->
                                                ...
                                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete"
                                                    onclick="deleteModal(<?php echo e(json_encode($data)); ?>);"><i
                                                        class="la la-trash"></i>
                                                </button>
                                        <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit"
                                            onclick="EditData(<?php echo e(json_encode($data)); ?>);"> <i class="la la-edit"></i>
                                        </button>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select readonly disabled class="form-control" name="customerID"
                                        id="customer_id_<?php echo e($customer->idNumber); ?>">
                                        <option value="">Enter Customer ID Number:</option>
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<div class="modal fade" id="deleteRequirment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
				<form action="<?php echo e(route('deletenonconfimity')); ?>" method="POST">
					<?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/dashboard/form_records/non_conformities.blade.php ENDPATH**/ ?>