	...
	<div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
		<div class="kt-aside__brand-logo">
			<a href="<?php echo e(url('/home')); ?>">
				<img alt="Logo" src="public/<?php echo e(Auth::user()->profile_image); ?>" width="84px"/>
	...
	<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
		<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
			<ul class="kt-menu__nav ">
				...
				<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
					...
					<div class="kt-menu__submenu ">
						...
						<ul class="kt-menu__subnav">
							...
							<li class="kt-menu__item " aria-haspopup="true">
								<a href="<?php echo e(url('enviornment_policy')); ?>" class="kt-menu__link ">
									<i class="kt-menu__link-bullet kt-menu__link-bullet--dot">
										<span></span>
									</i>
				...
				<li class="kt-menu__item   kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
					<a href="<?php echo e(url('contact_us')); ?>" class="kt-menu__link kt-menu__toggle">
						<span class="kt-menu__link-icon">
				...
				<li id="notifications" class="kt-menu__item   kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
					<a href="<?php echo e(route('inboxmessage')); ?>" class="kt-menu__link kt-menu__toggle">
						<span class="kt-menu__link-icon">
				...
				<li class="kt-menu__item   kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
					<a href="<?php echo e(url('/users_messages')); ?>" class="kt-menu__link kt-menu__toggle">
						<span class="kt-menu__link-icon">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
...
<!-- end:: Aside -->
<?php /**PATH /home/hashir/Documents/myiso/resources/views/dashboard/includes/sidebar.blade.php ENDPATH**/ ?>