                                        	...
                                        	<div class="modal-dialog" role="document">
                                        		<div class="modal-content">
                                        			...
                                        			<div class="modal-footer">
                                                      <form action="<?php echo e(route('deleteChemical2')); ?>" method="POST">
                                                         <?php echo csrf_field(); ?>     
                                                          <?php 
                                                                $urlparam = request()->route()->parameters;
                                                            ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/chemical_record.blade.php ENDPATH**/ ?>