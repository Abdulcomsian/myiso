        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    &nbsp;
                    <button onclick="editDetails(<?php echo e(Auth::user()); ?>)" class="btn btn-brand btn-elevate btn-icon-sm">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="procedure_div">
                    ...
                    <td><a href="https://myisoonline.com/public/<?php echo e(Auth::user()->company_profile); ?>" target="blank">View Company Profile</a> </td>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">	
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form class="kt-form kt-form--label-right" method="POST" action="<?php echo e(route('UpdateUserInfo')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="kt-input-icon kt-input-icon--right">
                                            ...
                                            <div class="downloadlink">
                                               <a target="_blank" href="https://myisoonline.com/public/<?php echo e(Auth::user()->company_profile); ?>" target="blank">View Profile</a>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hashir/Documents/myiso/resources/views/dashboard/procedure/userprofile.blade.php ENDPATH**/ ?>