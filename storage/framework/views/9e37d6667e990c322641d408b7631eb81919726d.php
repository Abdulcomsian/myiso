						...
						<div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
							<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
								<ul class="kt-menu__nav ">
									<li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here kt-menu__item--active"><a href="<?php echo e(url('/home')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">My ISO Online</span></a>
...
<input type="submit" class="btn btn-label-brand btn-sm btn-bold" value="Sign Out">
					...
					<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							<div class="kt-subheader__main">
								...
								<span class="kt-subheader__desc"><b>Company ID:</b> <?php echo e(Auth::user()->order_number); ?> </span>
		...
		<!-- end::Scrolltop -->
<?php /**PATH /home/hashir/Documents/myiso/resources/views/dashboard/includes/primary-header.blade.php ENDPATH**/ ?>