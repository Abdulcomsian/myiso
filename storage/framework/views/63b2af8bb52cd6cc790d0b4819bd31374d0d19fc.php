                                ...
                                <table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="">
                                    ...
                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View" value="" onclick="viewEid(<?php echo e($item); ?>);"><i class="la la-info"></i>
                                                </button>
                                                <button  data-toggle="modal" onclick="getEid(<?php echo e($item); ?>);" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="edit" value=""><i class="la la-edit"></i>
                                                </button>
                                                <button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="delete" value="" onclick="deletethisitem(<?php echo e($item); ?>);"><i class="la la-trash"></i>
                                                </button>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/dashboard/form_records/customer.blade.php ENDPATH**/ ?>