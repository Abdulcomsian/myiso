				...
				<p>Work instructions are procedures that are used locally to support what the business does. If you use documents that are external to this system, that is fine as long as they are referenced here. Do this by recording the work instruction detail and put a brief summary in the scope section. This will ensure that your external work instruction is included in the document register.</p>
                    <div class="procedure_div">
                    	...
                    	<div class="work_instruction_from_div">
                            <form action="<?php echo e(route('workinstructions')); ?> " method="POST">
                                <?php echo csrf_field(); ?>
                                                                <?php echo csrf_field(); ?>
                                            <?php 
											...
											<label>Employee ID Number of Work Instruction Creater. This is taken from the Employee table:</label>
											 <select class="form-control" name="empId" required="required">
											     <option value="">Select Employee</option>
											      ...
											      <option value="<?php echo e($emp->empNumber); ?>"><?php echo e($emp->empNumber); ?></option>
								...
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="kt_table_agent">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo e($data->workinstruction); ?></td>
                                            <td><?php echo e($data->instructionref); ?></td>
                                            <td><?php echo e($data->scop); ?></td>
                                           
                                            <td><?php echo e(isset($data->CompiledBy) ? $data->CompiledBy :''); ?></td>
                                            <td><?php echo e(date('d-M-Y', strtotime($data->issueDate))); ?></td>
                                            <td><?php echo e($data->revisionstatus); ?></td>
                                            <td>
                                                <button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View" onclick="getEid(<?php echo e($data); ?>);"><i class="la la-info"></i>
											    </button>
                                                <button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit"  onclick="editDetails(<?php echo e($data); ?>);"><i class="la la-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="modal" data-target="#deleteworkinst<?php echo e($data->id); ?>">
                                                    <i class="la la-trash"></i>
                                                 </button>
                                                 <div class="modal fade" id="deleteworkinst<?php echo e($data->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                	<div class="modal-dialog" role="document">
                                                		<div class="modal-content">
                                                            ...
                                                            <form action="<?php echo e(route('deleteWork')); ?>" method="POST">
                                                				<?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                ...
                                <!--<input type="number" readonly disabled class="form-control" name="empId">-->
                                 <select class="form-control" name="empId" required="required">
								     <option value="">Select Employee</option>
								      <?php $__currentLoopData = $employess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								      <option value="<?php echo e($emp->id); ?>"><?php echo e($emp->empNumber); ?></option>
								      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								 </select>
                            </div>
                        </div>
...
<div class="modal fade" id="editworkinstuction" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
            ...
            <form action="<?php echo e(route('editworkinstructions')); ?> " method="POST">
                <?php echo csrf_field(); ?>
                                            <?php 
            $urlparam = request()->route()->parameters;
            ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/work_instruction.blade.php ENDPATH**/ ?>