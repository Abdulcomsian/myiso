			...
			<div class="col-lg-12">
                    ...
                    <p>To add a record, click on the
                    	...
                    	<div class="process_audit_from_div">
                    		<form action="<?php echo e(route('auditsaveadmin')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php 
                    	...
                    	<div class="requirments_table_div">
                    		...
                    		<div class="kt-portlet__body table-responsive">
								...
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="kt_table_agent">
									...
									<tbody>
                                        <?php $counter=0; ?>
                                        <?php $__currentLoopData = $getprocess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $counter++; ?>
										<tr>
											...
											<td><button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit" onclick="getEid(<?php echo e($data); ?>);"><i class="la la-edit"></i></button>
										<button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View" onclick="viewaudit(<?php echo e($data); ?>)"><i class="la la-info"></i></button> 
										<button  class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete" onclick="deleteModal(<?php echo e($data); ?>)"><i class="la la-trash"></i></button> 
                                    </td>
                                        </tr>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="<?php echo e(route('deleteauditadmin')); ?> " method="POST">
				<?php echo csrf_field(); ?>
...
<div class="modal fade" id="editProcessAudit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content modal-lg">
            ...
            <form action="<?php echo e(route('auditupdateadmin')); ?>" method="POST">
                <?php echo csrf_field(); ?>
			<div class="modal-body">
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myiso\resources\views/admin/adminform_records/process_audit.blade.php ENDPATH**/ ?>