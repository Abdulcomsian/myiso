...
class HazardController extends SimpleRegisterController
{
    ...
    protected function module()
    {
        return [
            ...
            'info_items' => ['Slips, trips, falls', 'Sharp objects or machinery', 'Chemicals or substances', 'Heavy lifting or repetitive work'],
            ...
            'label_field' => 'hazard',
            'fields' => [
                'hazard' => ['label' => 'Hazard', 'type' => 'text', 'required' => true, 'wide' => true, 'placeholder' => 'Example: Slips on wet floor, Sharp tools, Chemical burn'],
                'risk' => ['label' => 'Risk / Impact', 'type' => 'text', 'required' => true, 'wide' => true, 'placeholder' => 'Example: Staff could break leg, Visitor could get hurt, Severe burn'],
                'controls' => ['label' => 'Controls', 'type' => 'text', 'required' => true, 'wide' => true, 'placeholder' => 'Example: Keep floor dry, Use guards on tools, Store chemicals safely'],
