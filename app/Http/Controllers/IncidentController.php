    ...
    protected function module()
    {
        return [
            ...
            'fields' => [
                ...
                'status' => ['label' => 'Status', 'type' => 'select', 'default' => 'open', 'options' => [
                    'open' => 'Open',
                    'investigating' => 'Investigating',
                    'closed' => 'Closed',
                ]],
                'description' => ['label' => 'Description', 'type' => 'textarea','placeholder' => 'What happened - what caused the incident?'],
                'injured_person' => ['label' => 'Who Was Involved / Injured', 'type' => 'text','placeholder' => 'Name of person affected'],
                'severity' => ['label' => 'Injury Severity', 'type' => 'select', 'options' => [
                    'none' => 'No injury (near-miss)',
                    'minor' => 'Minor',
                    'moderate' => 'Moderate',
                    'severe' => 'Severe',
                ]],
                'location' => ['label' => 'Location / Department', 'type' => 'text','placeholder' => 'Where did it happen?'],
