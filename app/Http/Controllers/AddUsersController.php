               ...
               // dd($end_date);
                if(isset($request->filter_by_certificate)){
                    ...
                    if($request->filter_by_certificate=="iso9001_certificate"){  
                        ...
                        $users=AddUsers::where([["last_login",">=", $start_date],["last_login","<=", $end_date]])->orwhereNotNull("iso9001_certificate")->orWhereNotNull("iso14001_certificate")->orWhereNotNull("iso45001_certificate")->get();
