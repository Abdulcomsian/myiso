...
<div class="am-content">
    ...
    <div class="am-page-header">
        <div>
            <h2>QP3 – Servicing a Contract Process</h2>
            <p>Process flow chart for servicing contracts</p>
        </div>
    ...
    <div class="am-card">
        <div class="am-card__body" style="padding:32px; line-height:1.8;">
            ...
            @endif
            <p>This process is to be used when completing the contract from the customer.</p>
            <p><strong>Input:</strong> Reception of the purchase order from the customer.</p>
            <p><strong>Output:</strong> Delivery and invoice of the goods or service.</p>
            <p><strong>Process owner:</strong> {{ Auth::user()->servicing_process }}</p>
        </div>
    </div>
