...
<div class="am-content">
    ...
    <div class="am-page-header">
        <div>
            <h2>QP1 – Sales Process</h2>
            <p>Process flow chart for sales</p>
        </div>
    ...
    <div class="am-card">
        <div class="am-card__body" style="padding:32px; line-height:1.8;">
            ...
            @endif
            <p>This process is to be used to begin a contract from customer.</p>
            <p><strong>Input:</strong> Request to quote.</p>
            <p><strong>Output:</strong> Reception and implementation of a purchase order.</p>
            <p><strong>Process owner:</strong> {{ Auth::user()->sales_process }}</p>
        </div>
    </div>
