		...
		<div class="row">
			...
			<p>To add a record, click on the “Add Employee” button. To amend a record, click on the edit icon of the entry that needs to be modified or deleted.</p>
				...
				@endif
                    <div class="procedure_div">
                    	<div class="row">
                    		<div class="col-lg-12 text-right">
                    			<a onclick="employeeForm()" class="addBtn">ADD EMPLOYEE</a> 	&nbsp; <a onclick="employeeSkillForm()" class="addBtn">ADD PROCESS SKILL FOR EMPLOYEE</a> &nbsp; <a onclick="employeeRecordForm()" class="addBtn">ADD A TRAINING RECORD FOR EMPLOYEE</a>
                    		</div>
                    	</div>
                    ...
                    <div class="procedure_div m-t-20 skill">
                    	<!--<div class="row">-->
                    	<!--	<div class="col-lg-12 text-right">-->
                    ...
                    <div class="procedure_div m-t-20 record">
                    	<!--<div class="row">-->
                    	<!--	<div class="col-lg-12 text-right">-->
                    ...
                    <div class="procedure_div">
                    	<div class="requirments_table_div" style="margin-top: 0px;">
                    		...
                    		<div class="kt-portlet__body table-responsive">
								<!--begin: Datatable -->
								<table class="common_table table table-striped- table-bordered table-hover table-checkable table-responsive" id="kt_table_agent2">
									<thead>
										<tr>
