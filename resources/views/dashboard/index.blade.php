								...
								<div class="col-xl-8">
									...
									<div class="kt-portlet kt-portlet--height-fluid">
									 ...
									 $d = strtotime($data->completion_date);
											                        ...
											                        <td>{{ date("d-M-Y",$d)}}</td>
																	<!--<td>{{ $data->due_date}}</td>-->
																	<td><a href="#" data-id="{{$data->id}}" class="delete_requirement" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">	
...
>>>>>>> ad9ff2b69d308e1149a5f6058a113e0dacf6d864
