...
<div class="am-content">
    ...
    <div class="am-page-header">
        <div>
            ...
            <p>Document control procedure and records management</p>
        </div>
    </div>
    ...
    <div class="am-card">
        <div class="am-card__body" style="padding:32px; line-height:1.8;">
            ...
            <h4 class="mt-4">3. Controlled documents</h4>
            <h5 class="mt-3">3.1 Definition</h5>
            ...
            <h5 class="mt-3">3.2 Authorisation</h5>
            ...
            <h5 class="mt-3">3.5 Identification of changes</h5>
            <p>Changes where considered appropriate, shall be identified in the FAQ section.</p>

            <h5 class="mt-3">3.6 Distribution</h5>
            ...
            <h5 class="mt-3">3.8 Local documents held on computer for direct reference</h5>
            ...
            <h5 class="mt-3">3.9 Uncontrolled documents</h5>
            ...
            <h4 class="mt-4">5. Documents of external origin</h4>
            <h5 class="mt-3">5.1 Master copies</h5>
            <p>The quality representative shall keep the master copy of all reference documents of external origin, e.g. British Standards, copies of legislation, codes of practice.</p>

            <h5 class="mt-3">5.2 Updating standards</h5>
            <p>Updated standards shall be checked every 6 months by visiting the appropriate website.</p>

            <h5 class="mt-3">5.3 Updating legislation</h5>
            ...
            <h5 class="mt-3">5.4 Obtaining up-to-date documents</h5>
            ...
            <h4 class="mt-4">6. Obsolete documents</h4>
            ...
            <h4 class="mt-4">8. Retention time</h4>
            ...
            <h4 class="mt-4">9. Computer records</h4>
