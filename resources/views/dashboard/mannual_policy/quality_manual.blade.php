		...
		?>
				<h4>1. Scope</h4>
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="021px;"><span class="authName" >{{ Auth::user()->Company_overview}}</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="018px;">The scope for <span class="authName" >{{ Auth::user()->company_name}}</span> is: "{{ Auth::user()->scope}}"</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
...
">4.3.3.2 -</p>
						...
						<div class="list_content">
							<p style="012px;">These exclusions are applicable because of their non-relevance to the activities of <span class="authName" >{{ Auth::user()->company_name}}</span> or to their desired scope of registration. Not doing this element does not impact on the product or service provided to the customers.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="020px;">The following key processes are used and defined by
								 <span class="authName" >{{Auth::user()->company_name}}</span>.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="015px;">The Management of <span class="authName" >{{Auth::user()->company_name}}</span> are committed to a policy of continuous improvement in all aspects of its business operations, together with the effective implementation and continuous improvement of our QMS in order to provide enhanced Customer satisfaction and added value to the business. Management will ensure that the importance of meeting Customer, regulatory and legal requirements is effectively communicated within the organisation.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="021px;">The Management of <span class="authName" >{{Auth::user()->company_name}}</span> are committed to providing products and services that consistently exceed our Customer’s needs and expectations for Quality and Value.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="022px;">As part of our policy of continual improvement, <span class="authName" >{{Auth::user()->company_name}}</span> has established documented procedures to provide for the review and analysis of information derived from the QMS processes.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="025px;">The Management of <span class="authName">{{Auth::user()->company_name}}</span> will ensure that resources required are determined and available, in order to ensure the effective operation of the QMS and achievement and enhancement of Customer satisfaction.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="014px;"><span class="authName" >{{Auth::user()->company_name}}</span> is committed to ensuring that suitable infrastructure in terms of buildings; facilities and equipment are identified, acquired, and adequately maintained.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="014px;">The Management of <span class="authName" >{{Auth::user()->company_name}}</span> will ensure that all aspects of the work environment having an effect on product conformance are identified, and effectively managed at all times.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="014px;"><span class="authName" >{{Auth::user()->company_name}}</span> operates a QMS based upon the requirements of ISO 9001:2015, structured as detailed below:</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
...
">7.5.3.3 -</p>
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="06px;">Additional requirements determined by <span class="authName" >{{Auth::user()->company_name}}</span>.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="09px;">All Customer enquiries and orders will be reviewed to ensure that <span class="authName" >{{Auth::user()->company_name}}</span> has the capability to meet Customer’s specified requirements for quality, delivery and cost.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
...
">8.2.3.2 -</p>
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="06px;"><span class="authName" >{{Auth::user()->company_name}}</span> has the ability to meet these requirements.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="014px;">All products will be suitably identified throughout its lifecycle within <span style="color: #000;">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="012px;"><span class="authName">{{Auth::user()->company_name}}</span> shall ensure all products delivered to site are suitably identified, handled, protected from damage and environmentally controlled when required.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="018px;">Verification of materials and products at the Supplier’s premises undertaken by <span class="authName">{{Auth::user()->company_name}}</span> shall be clearly documented within associated Purchase documentation and agreed with the Supplier concerned.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="018px;">The Management of <span class="authName">{{Auth::user()->company_name}}</span> recognise that Internal <a href="{{url('/auidt')}}">Audits</a> play a fundamental role in the control and improvement of the QMS.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
					...
					<div class="list_div">
						...
						<div class="list_content">
							<p style="020px;"><span class="authName" >{{Auth::user()->company_name}}</span> is committed to a policy of continual improvement in all aspects of our business. The QMS effectively contributes towards the achievement of our Quality Policies and Objectives.</p>
						</div>
					</div>
					<div class="list_div">
						<div class="list_number">
