...
<div class="am-content">
    ...
    <div class="am-page-header">
        ...
        <div>
            <button type="button" onclick="qualityshowpolicy()" class="am-btn am-btn-primary"><i class="fa fa-plus"></i> Add Environmental Policy</button>
        </div>
    </div>
    ...
    <div class="am-card quality_add_div" style="display:none;">
        <div class="am-card__body am-form">
            <h6 class="dash-section-title">Add Environmental Policy</h6>
