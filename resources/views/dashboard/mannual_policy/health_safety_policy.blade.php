...
<div class="am-content">
    ...
    <div class="am-page-header">
        ...
        <div>
            <a onclick="qualityshowpolicy()" class="am-btn am-btn-primary">Add Health and Safety Policy</a>
        </div>
    </div>
    ...
    <div class="am-card">
        <div class="am-card__body" style="padding:32px; line-height:1.8;">
            ...
            <h6 class="dash-section-title mt-4">Duties of Employers:</h6>
            ...
            <h6 class="dash-section-title mt-4">Duties of Employees:</h6>
            ...
            <h6 class="dash-section-title mt-4">Additional Policies — Purpose:</h6>
