...
<div class="am-content">
    ...
    <div class="am-page-header">
        ...
        <div>
            <button type="button" onclick="qualityshowpolicy()" class="am-btn am-btn-primary"><i class="fa fa-plus"></i> Add Quality Policy</button>
        </div>
    </div>
        ...
        <div class="am-card__body am-form">
            ...
            <form action="{{ route('add_quality') }}" id="addcust" method="post">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="message" maxlength="10000" class="form-control mt-2" rows="6" placeholder="Set a maximum for the number of character that can be entered to 10000." required></textarea>
                    @error('message')
