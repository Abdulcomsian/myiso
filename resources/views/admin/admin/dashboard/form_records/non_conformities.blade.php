								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="date" class="form-control" aria-describedby="emailHelp" placeholder="Enter Prevent Recurrence:">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="date" class="form-control" aria-describedby="emailHelp" placeholder="Enter Review Performed:">
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="date" class="form-control" aria-describedby="emailHelp" placeholder="Enter Product Impact:">
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
