		...
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/bootstrap-datepicker/init.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/bootstrap-timepicker/init.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/bootstrap-switch/init.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/bootstrap-markdown/init.js') }}" type="text/javascript"></script>
		<script src="{{ asset('public/assets/vendors/general/bootstrap-notify/bootstrap-notify.min.js') }}" type="text/javascript"></script>
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/bootstrap-notify/init.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/jquery-validation/init.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('public/assets/vendors/custom/components/vendors/sweetalert2/init.js') }}" type="text/javascript"></script>
		...
		<script src="{{ asset('public/assets/app/custom/general/dashboard.js') }}" type="text/javascript"></script>
		...
		@if(Request::is('products*'))
			...
			<script src="{{ asset('public/assets/app/custom/product/listing.js') }}" type="text/javascript"></script>
		@endif
		...
		@if(Request::is('user*') || Request::is('customer*') || Request::is('agent*'))
			...
			<!--begin::Product Page Scripts(used by this page) -->
			<script src="{{ asset('public/assets/app/custom/user/listing.js') }}" type="text/javascript"></script>

			<!--begin::Page Scripts(used by this page) -->
			<!-- <script src="{{ asset('public/assets/dropzone/dist/dropzone.js') }}" type="text/javascript"></script> -->

			<!--end::Page Scripts -->
		@endif

		<!--begin::Page Scripts(used by this page) -->
		<script src="{{ asset('public/assets/app/custom/general/crud/forms/widgets/bootstrap-datepicker.js') }}" type="text/javascript"></script>

		<!--end::Page Scripts -->

		<!--begin::Global App Bundle(used by all pages) -->
		<script src="{{ asset('public/assets/app/bundle/app.bundle.js') }}" type="text/javascript"></script>
