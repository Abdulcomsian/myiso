...
<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content" style="padding:26px;">
    ...
    <div class="am-card" style="margin-bottom:16px;">
        <div class="am-card__toolbar">
            <form method="GET" action="{{ url('/supplierReviewad/' . $urlparam['userid']) }}" class="am-search" id="amSrSearchForm" style="flex:1;max-width:340px;margin:0;">
    ...
    <div class="am-card">
        <div id="amSrContainer">
            @include('admin.adminform_records.partials.supplier_review_table')
        </div>
    </div>
</div>
...
(function() {
    ...
    if (!container) return;
    var baseUrl = '{{ url('/supplierReviewad/' . $urlparam['userid']) }}';
