...
<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content" style="padding:26px;">
    ...
    <div class="am-card" style="margin-bottom:16px;">
        <div class="am-card__toolbar">
            <form method="GET" action="{{ url('/calibrationcheck/' . $urlparam['userid']) }}" class="am-search" id="amCalSearchForm" style="flex:1;max-width:340px;margin:0;">
    ...
    <div class="am-card">
        <div id="amCalContainer">
            @include('admin.adminform_records.partials.calibration_table')
        </div>
    </div>
</div>
...
<div style="display:none;">
        <div class="am-table-wrap">
            <table class="am-table" id="amCalTable_OLD">
                <thead>
                    <tr>
        ...
        <form action="{{ route('calibrationedit') }}" method="POST" enctype="multipart/form-data" style="display:contents;">
            ...
            <div class="am-modal__body" style="padding:20px;">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4"><label>Sentence</label>
...
(function() {
    ...
    if (!container) return;
    var baseUrl = '{{ url('/calibrationcheck/' . $urlparam['userid']) }}';
