...
<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content" style="padding:26px;">
    ...
    <div class="am-card" style="margin-bottom:16px;">
        <div class="am-card__toolbar">
            <form method="GET" action="{{ url('/supplierCheck/' . $urlparam['userid']) }}" class="am-search" id="amSupSearchForm" style="flex:1;max-width:340px;margin:0;">
    ...
    <div class="am-card">
        <div id="amSupContainer">
            @include('admin.adminform_records.partials.supplier_table')
        </div>
    </div>
</div>
...
<div style="display:none;">
        <div class="am-table-wrap">
            <table class="am-table" id="amSupTable_OLD">
                <thead>
                    <tr>
...
<script>
    ...
    (function() {
        ...
        if (!container) return;
        var baseUrl = '{{ url('/supplierCheck/' . $urlparam['userid']) }}';
