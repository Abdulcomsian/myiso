			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_user">
				...
				<tbody>
					<tr>
						...
						<td>abc@gmail.com</td>
						<td>090078601</td>
						<td>xyz, street no 2, Rawalpindi</td>
						<td>June, 2022</td>
						<td>
							<a href="/edit_user" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit Customer">
                        	...
                        	<a data-toggle="modal" data-target="#deleteUser" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete Customer">
