...
<!-- begin:: Content -->
<style> .new-file-upload{display: block;width: 91px;height: 34px;position: absolute;top: 23px;font-size: 12px;background: #FFF;border-radius: 4px;border: 1px solid #0d47b3;}</style>
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
	...
	<div class="alert alert-{{$class}} alert-dismissible">{{ $message }} &nbsp; <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a></div>
	</div>
	</div>
	@endif
						...
						<div class="form-group row">
							...
							<div class="col-lg-3">
								...
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text"  id="order_number" name="order_number" class="form-control" placeholder="Enter Company ID Number" required>
							...
							<div class="col-lg-6">
								...
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="director" name="director" class="form-control" placeholder="Enter a Name" required>
								</div>
...
<div class="form-group row">
							...
							<div class="col-lg-4">
								<label for="contact_iso" style="text-align:left;">Contact number of the person responsible for ISO:</label>
								<div class="kt-input-icon kt-input-icon--right"> 
							...
							<div class="col-lg-4">
								<label for="email_iso text-left" style="text-align:left;">Email Address of the person responsible for ISO:</label>
								<div class="kt-input-icon kt-input-icon--right">
							...
							<div class="col-lg-4">
								...
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="sales_process" name="sales_process" class="form-control" placeholder="Enter a Name." required>
								</div>
							</div>
							<div class="col-lg-4">
								<label for="purchasing_process">Purchasing Process Owner:</label>
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="purchasing_process" name="purchasing_process" class="form-control" placeholder="Enter a Name." required>
								</div>
							</div>
							<div class="col-lg-4">
								<label class="" for="servicing_process">Servicing of Contract Process Owner:</label>
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="servicing_process" name="servicing_process" class="form-control" placeholder="Enter a Name." required>
								</div>
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col-lg-4">
								...
								<div class="kt-input-icon kt-input-icon--right">
									<input type="text" id="competency_process" name="competency_process" class="form-control" placeholder="Enter a Name." required>
								</div>
							</div>
						<div class="col-lg-4">
								<label for="address2">Company Profile / Business Overview:</label>
								<div class="kt-input-icon kt-input-icon--right">
									<input type="file" id="company_profile" name="company_profile" class="form-control" placeholder="Company Profile" required>
								</div>
							</div>
							<div class="col-lg-4">
						...
						<div class="form-group row">
							...
							<textarea id="Company_overview" name="Company_overview" class="form-control" placeholder="Enter Company Overview" style="height: 190px;" required></textarea>
							...
							<div class="col-lg-3">
								...
								<div class="kt-input-icon kt-input-icon--right">
									...
									<div id="image-preview">
									  ...
									  <input type="file"accept="image/*" name="user_image" id="file" onchange="loadFile(event)"  required>
							...
							<div class="col-lg-4">
								...
								<input type="date" id="iso9001_expirydate" name="iso9001_expirydate" class="form-control" placeholder="Expiry Date" >
							</div>
							<div class="col-lg-4">
								<label for="iso9001_description">Description:</label>
								<textarea id="iso9001_description" name="iso9001_description" class="form-control" placeholder="Description for ISO9001 Certificate"></textarea>
							</div>					
						...
						<div class="form-group row">
							...
							<div class="col-lg-4">
								...
								<input type="date" id="iso14001_expirydate" name="iso14001_expirydate" class="form-control" placeholder="Expiry Date">
							</div>
							<div class="col-lg-4">
								<label for="iso14001_description">Description:</label>
								<textarea id="iso14001_description" name="iso14001_description" class="form-control" placeholder="Description for ISO14001 Certificate" ></textarea>
							</div>					
						...
						<div class="form-group row">
							...
							<div class="col-lg-4">
								...
								<input type="date" id="iso45001_expirydate" name="iso45001_expirydate" class="form-control" placeholder="Expiry Date" >
							</div>
							<div class="col-lg-4">
								<label for="iso45001_description">Description:</label>
								<textarea id="iso45001_description" name="iso45001_description" class="form-control" placeholder="Description for ISO45001 Certificate" ></textarea>
							</div>					
...
<button type="submit" id="submit" class="submitBtn" style="margin-right: -28px;">SUBMIT</button>
<button type="reset" class="submitBtn" onclick="window.location.href='{{url('/admin')}}'" style="margin-right:10px">Cancel</button>					    
