...
<div class="kt-content kt-grid__item kt-grid__item--fluid" id="kt_content" style="padding:26px;">
    ...
    <div class="am-page-header">
        <div>
            <h2>Inbox</h2>
            <p>Messages received from clients. Click a conversation to open the thread.</p>
        </div>
        <div>
    ...
    <div class="am-card">
        <div class="am-card__toolbar">
            <form id="amInboxSearchForm" class="am-search" style="flex:1;max-width:340px;margin:0;" onsubmit="return false;">
                ...
                <input type="text" id="amInboxSearch" name="q" value="{{ $search ?? '' }}" placeholder="Search conversations…" autocomplete="off">
            </form>
            <div style="margin-left:auto;font-size:12.5px;color:var(--am-text-muted);">
                <strong>{{ number_format($totalConvos ?? 0) }}</strong> total conversation{{ ($totalConvos ?? 0) === 1 ? '' : 's' }}
            </div>
        </div>
