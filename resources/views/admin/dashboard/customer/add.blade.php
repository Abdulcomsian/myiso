				...
				<form class="kt-form kt-form--label-right" method="POST" action="{!! route('users.store') !!}" enctype="multipart/form-data">
					...
					<div class="kt-portlet__body">
						...
						<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_customer_plane">
							...
							<tbody id="kt_customer_plane_body"></tbody>
						</table>
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-12">
									<p class="addPlane"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Plane</p>
								</div>
							</div>
						</div>
						<!--end: Datatable -->
						...
						<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_customer_plane">
							...
							<tbody id="kt_customer_note_body"></tbody>
						</table>
						<div class="container-fluid">
							<div class="row">
								<div class="col-lg-12">
									<p class="addNote"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Note</p>
								</div>
							</div>
						</div>
						<!--end: Datatable -->
