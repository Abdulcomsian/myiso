...
//Route::get('/', function () { return view('auth.test'); })->middleware(['guest']);
...
Route::group(['middleware' => ['auth']], function () 
{
    ...
    // Route::get('/schedule-training', function () {
    //     return view('dashboard.schedule_training');
    ...
    Route::post('/remove_iso', 'UserInfoController@remove_iso');
     Route::post('/remove_qa_iso', 'UserInfoController@remove_qa_iso');
